...
#aqui aguarda a resposta de se o sistema ta online e  espera o operador fazer as requisicoes , que alterna entre pedir posicao, definir novas e testar solicitaces invalidas
