...
#configuração de canal  subscricao
#depois nos temos nossa funcao
...
# aqui nos temos nosso loop principal 
while True:
    print('shadsga')    
...
#aqui temos nossa proxima  funcao
